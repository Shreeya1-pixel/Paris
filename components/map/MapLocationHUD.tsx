...
export function MapLocationHUD({ status, lat, lng, tracking }: MapLocationHUDProps) {
  ...
  return (
    <>
      {showBanner && (
        <div className="absolute top-[72px] left-3 right-3 z-30 pointer-events-none flex justify-center">
          <div
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="absolute top-[120px] left-2 z-30 max-w-[200px] pointer-events-none">
